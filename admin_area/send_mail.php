        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-tags fa-fw"></i> Send Mail To All The Registered Users
            ...
            <div class="panel-body"><!-- panel-body begin -->
                ...
                <?php 
                    ...
                    while($row_exams=mysqli_fetch_array($run_exams)){
                        ...
                        $get_result="select COUNT(u_id) as nmbr from reg_exam where exam_id='$exam_id'";
                ...
                <div class="col-lg-3 col-md-3"><!-- col-lg-3 col-md-3 begin -->
                    <div class="panel panel-primary"><!-- panel panel-primary begin -->
                        ...
                        <div class="panel-body"><!-- panel-body begin -->
                            ...
                            <h4 class="text-center">Number Of Registered Students: <?php echo $number_of_participants;  ?></h4>
                        ...
                        <div class="panel-footer"><!-- panel-footer begin -->
                            <center><!-- center begin -->
                                ...
                                <a href="index.php?mail_sending=<?php echo $exam_id; ?>" class="w-100"><!-- pull-right begin -->
                                
                                 <i class="fa fa-fw fa-book"></i> Click to send Mails
